...
function ManageDailyMenu() {
  ...
  return (
    <AdminLayout
      title="Today's menu"
      description="Select existing menu items for today's service."
    >
      <div className="admin-content">
        {error && <p className="form-error">{error}</p>}
        {notice && <p className="form-notice">{notice}</p>}
        {loading ? (
          <p className="admin-loading">Preparing today&apos;s menu…</p>
        ) : (
          <div className="daily-grid">
            <section className="admin-panel">
              <div className="panel-heading">
                <div>
                  <p className="panel-label">Serving today</p>
                  <h2>{todayItems.length} selected dishes</h2>
                </div>
              </div>
              {todayItems.length ? (
                ...
                <div className="admin-empty">
                  <strong>No dishes selected yet</strong>
                  <p>
                    Select dishes from the collection to publish them to
                    customers.
                  </p>
                </div>
              )}
            ...
            <section className="admin-panel">
              <div className="panel-heading">
                <div>
                  <p className="panel-label">Your collection</p>
                  <h2>Add dishes</h2>
                </div>
                <button
              ...
              <div className="selectable-items">
                ...
                {!availableToAdd.length && (
                  <p className="admin-empty">
                    All saved dishes are already on today&apos;s menu.
                  </p>
                )}
              </div>
            </section>
        ...
        {itemToRemove && (
          <div className="modal-backdrop" role="presentation">
            ...
            >
              ...
              <p>
                This dish will no longer appear on today&apos;s customer menu.
                It will remain in your complete menu collection.
              </p>
